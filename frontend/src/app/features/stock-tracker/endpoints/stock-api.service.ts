...
import { Earnings, EarningsWrapper } from "../model/symbolModel";
...
export class StockApiService {
  ...
  getEarningsCalendar(): Observable<Earnings[]> {
    return this.http
      .get<EarningsWrapper>(`${environment.stockAPI}/economics/earnings`)
