...
// 	console.log(`Got: ${refs.length} results`);
// 	console.log('Loop');
...
// 			const transactionSnapshots = data.transactionSnapshots.filter((t) => t.transactionFees !== undefined || t.transactionFees !== null);
		...
		try {
			...
			await ref.set(
				<api.STUserPublicData>{
					...
					// 	...createEmptyRank(),
					// },
					lastPortfolioUpdateDate: yesterday.toISOString(),
					// topTransactions,
