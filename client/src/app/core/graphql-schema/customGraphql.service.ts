...
export type StGroupAllData = {
  ...
  startedBalance?: Maybe<Scalars['Float']>;
...
export type StGroupIdentificationDataFragment = (
  { __typename?: 'STGroupAllData' }
  & Pick<StGroupAllData, 'groupId' | 'name' | 'description' | 'imagePath' | 'imageUrl' | 'startDate' | 'endDate' | 'isInfinite' | 'isPrivate' | 'numberOfExecutedTransactions' | 'numberOfMembers' | 'startedBalance' | 'lastUpdateDate' | 'lastEditedDate' | 'createdDate'>
  & { owner: (
    { __typename?: 'STGroupUser' }
...
export type StGroupAllDataFragmentFragment = (
  { __typename?: 'STGroupAllData' }
  & Pick<StGroupAllData, 'groupId' | 'name' | 'description' | 'imageUrl' | 'imagePath' | 'lastUpdateDate' | 'lastEditedDate' | 'createdDate' | 'startDate' | 'endDate' | 'isPrivate' | 'isInfinite' | 'numberOfExecutedTransactions' | 'numberOfMembers' | 'startedBalance'>
