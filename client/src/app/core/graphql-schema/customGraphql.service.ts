...
export type StfmCompanyQuoteFragmentFragment = { __typename?: 'STFMCompanyQuote', avgVolume?: number | null, change?: number | null, changesPercentage?: number | null, earningsAnnouncement?: string | null, eps?: number | null, exchange: string, marketCap?: number | null, name: string, pe?: number | null, previousClose?: number | null, price?: number | null, sharesOutstanding?: number | null, symbol: string, timestamp?: number | null, volume?: number | null, yearHigh: number, yearLow: number, image?: string | null };
