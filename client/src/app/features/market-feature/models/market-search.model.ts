...
export const MarketSearchCountries = ['US', 'CA', 'BM', 'FR', 'IE', 'MX', 'RU', 'CN', 'IN', 'HK', 'AU', 'NO', 'SE', 'GB', 'NL', 'ID', 'IL', 'KY', 'SG', 'DE', 'CY', 'BR', 'BE', 'NZ', 'GG', 'MO', 'AT', 'JP', 'AE', 'CH', 'PT', 'IT', 'FI', 'LU', 'MY', 'DK', 'ES', 'VG', 'IM', 'JE', 'TW', 'MC', 'MA', 'TH', 'ZA', 'PR', 'MN', 'CL', 'UY', 'GR', 'MU', 'GI', 'KR', 'VN', 'AR', 'AZ', 'CK', 'LI', 'MT', 'CR', 'PG', 'ZM', 'TR', 'DO', 'KH', 'PE', 'CO', 'PA', 'VI', 'UA', 'TG', 'TC', 'JO', 'BS', 'IS', 'CW', 'PH', 'FK', 'SK', 'GA', 'GE', 'BD', 'AI', 'NG', 'BG', 'LT', 'BB', 'SN'];
