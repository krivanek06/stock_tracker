import { StDetailsFinancialGrowthFragment, StDetailsFinancialRatiosFragment, StDetailsKeyMetricsFragment } from '@core';

export interface StockDetailsDisplayValue<T> {
	name: string;
	id: T;
	isPercent?: boolean;
}

export const StockDetailsFinancialGrowthDisplay: StockDetailsDisplayValue<keyof StDetailsFinancialGrowthFragment>[] = [
...
export const StockDetailsFinancialRatiosDisplay: StockDetailsDisplayValue<keyof StDetailsFinancialRatiosFragment>[] = [
	...
	{ id: 'fixedAssetTurnover', name: 'Fixed asset turnover', isPercent: true },
...
export const StockDetailsKeyMetricsDisplay: StockDetailsDisplayValue<keyof StDetailsKeyMetricsFragment>[] = [
