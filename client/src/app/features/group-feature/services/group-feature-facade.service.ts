...
export class GroupFeatureFacadeService {
    ...
    private watchActiveGroupChange() {
        this.activeGroupId$.pipe(
            filter(groupId => !!groupId),
            switchMap(groupId => this.graphqlGroupService.querySTGroupAllDataByGroupId(groupId))
        ).subscribe(res => this.groupStorageService.setActiveGroup(res));
    }
}
