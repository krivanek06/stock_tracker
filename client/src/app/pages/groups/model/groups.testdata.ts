...
const user: StGroupUser = {
	...
	locale: 'SK',
	photoURL:
		'https://firebasestorage.googleapis.com/v0/b/stocktrackertest-e51fc.appspot.com/o/groups%2Fthis.fileName?alt=media&token=c365ad0e-3268-4667-9f8c-6195bcbaef42',
	nickName: 'User 123',
...
const transaction: StTransaction = {
	...
	user: {
		photoURL:
			'https://firebasestorage.googleapis.com/v0/b/stocktrackertest-e51fc.appspot.com/o/users%2Fthis.fileName?alt=media&token=7e4fe244-cd7b-43a2-a95f-1fe5ef778932',
...
groupTestData.lastPortfolioSnapshot.portfolioInvested = groupTestData.holdings
	.map((h) => h.holding.units * h.holding.breakEvenPrice)
	.reduce((a, b) => a + b, 0);
